...
function HallScene:initBgLayer()
    ...
    room1Btn:addClickEventListener(function(sender)
        app:enterScene("RoomScene");
	end)
end

function HallScene:initItems()
